...
# License: MIT
# Pre-requisites: The `tidyverse` and 'testthat' package must be installed and loaded
...
#### Test data ####
# Test that the dataset has 1312 rows
test_that("dataset has 1312 rows", {
  expect_equal(nrow(analysis_data), 1312)
})
